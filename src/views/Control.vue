  ...
  <transition name="slider-up" appear>
    <div class="control">
      ...
      <div class="btn">
        ...
        <div class="icon" :title="t(ACTION_I18N.overlap)" @click="overlapChange" :class="{'icon-active': playSetting.overlap}">
        ...
        <div class="icon" :title="t(ACTION_I18N.autoRandom)" @click="autoRandomChange" :class="{'icon-active': playSetting.autoRandom}">
        ...
        <div class="icon" :title="t(ACTION_I18N.loop)" @click="loopChange" :class="{'icon-active': playSetting.loop}">
